                ...
                <div class="space-y-1">
                    ...
                    <div class="mt-1 group relative inline-block w-full">
                        <Field id="full_name" name="full_name" type="string" v-model="profile.full_name"
                            class="mt-1 block w-full rounded-md border border-gray-300 py-2 px-3 shadow-sm focus:border-spring-500 focus:outline-none focus:ring-spring-500 sm:text-sm" />
