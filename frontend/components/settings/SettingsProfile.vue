    ...
    <div class="w-full">
        <Form @submit="submit" :validation-schema="schema">
            <div class="space-y-6 bg-white py-6 px-4 sm:p-6">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        ...
                        <span v-if="!authStore.profile.password" class="font-bold">
            ...
            <div class="pb-6 text-right sm:px-6">
                <button type="submit"
                    :class="[authStore.profile.password ? 'bg-spring-500 hover:bg-spring-700 focus:outline-none focus:ring-2 focus:ring-spring-600 focus:ring-offset-2' : 'bg-spring-300', 'inline-flex justify-center rounded-md border border-transparent py-2 px-4 text-sm font-medium text-white shadow-sm']"
