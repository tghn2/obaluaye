        ...
        <div class="relative mt-1">
            ...
            <transition leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100"
                ...
                <ListboxOptions
                    ...
                    <ListboxOption v-slot="{ active, selected }" v-for="itype in ['MARKDOWN', 'WEBLINK']"
...
import { IResourceType, IKeyable } from "@/interfaces"

const { t } = useI18n()
const choice = ref("WEBLINK" as IResourceType)

// https://nuxt.com/docs/guide/directory-structure/components#dynamic-components
const inputType: IKeyable = {
    MARKDOWN: "resource.types.markdown",
    WEBLINK: "resource.types.weblink",
}

const props = defineProps<{
    initialType?: IResourceType,
}>()
const emit = defineEmits<{
    setSelect: [select: IResourceType]
}>()
...
// SETTERS
onMounted(async () => {
    if (props.initialType) choice.value = props.initialType
})
