...
import { IValueType, IKeyable } from "@/interfaces"

const { t } = useI18n()
const choice = ref("STRING" as IValueType)
...
const props = defineProps<{
    inputSelect: IValueType[],
    initialChoice: IValueType,
}>()
const emit = defineEmits<{
    setSelect: [select: IValueType]
}>()
...
// SETTERS
onMounted(async () => {
    choice.value = props.initialChoice
})
