<template>
    <div class="m-2">
            ...
            <div class="flex-auto text-sm text-gray-500">
                <dl>
                    ...
                    <div v-if="props.node.resources && props.node.resources.length" class="py-1 sm:px-1">
                        ...
                        <ul class="mt-1">
                            <li v-for="resource in props.node.resources" :key="resource.id">
        ...
        <JourneyReviewNodeCommentModal v-if="props.node.response && props.node.response.id"
            :response-id="props.node.response.id" :comment-count="(props.node.response.comments as number)" />
    </div>
</template>
