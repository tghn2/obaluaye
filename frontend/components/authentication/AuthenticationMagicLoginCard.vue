        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div
                ...
                <Form @submit="submit" :validation-schema="schema" class="w-full max-w-md">
                    ...
                    <p class="mt-4 text-sm leading-6 text-gray-300">We care about your data. Read our <LocaleLink
                            to="/privacy" class="font-semibold text-white">privacy policy</LocaleLink>.</p>
                </Form>
