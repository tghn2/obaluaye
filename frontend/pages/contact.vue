                    ...
                    <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
                                ...
                                <PhBuildings class="h-7 w-6 text-gray-400" aria-hidden="true" />
                            </dt>
                        ...
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
                                ...
                                <PhPhone class="h-7 w-6 text-gray-400" aria-hidden="true" />
                            </dt>
                        ...
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
                                ...
                                <PhEnvelopeSimple class="h-7 w-6 text-gray-400" aria-hidden="true" />
                            </dt>
...
import { PhBuildings, PhEnvelopeSimple, PhPhone } from "@phosphor-icons/vue"
