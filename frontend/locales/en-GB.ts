export default {
    ...
    seo: {
        title: "The 1000 Challenge Study Builder",
        description: "Supporting 1000 nurses, community and other allied health workers in leading pragmatic health research studies to outcomes in their patients whilst developing skills and leadership experience",
    },
    nav: {
        home: "Home",
        search: "View all studies",
        pathways: "Preview the steps",
        comments: "Comments",
        groups: "My studies",
        settings: "Profile",
        collection: "Dropdown",
    ...
    settings: {
        ...
        pathway: {
            title: "Profile",
            description: "Review and manage your profile.",
        },
        account: {
            title: "Profile",
            description: "You will need to enter a password before you can save your profile changes. Note, changing your email address will change your login. All fields are required.",
            passwordRequired: "You will need to enter a password before you can save your profile changes.",
        ...
        invitations: {
            ...
            completePathway: "You cannot participate in a study team until you have completed your profile.",
            invited: "Invited",
            for: "For",
            by: "By",
            accept: "Accept",
        ...
        security: {
            title: "Security",
            description: "Manage your password, or enable two-factor security.",
        ...
        field: {
            subjects: "Keywords or search terms that best describe your skills",
        },
        help: {
    ...
    start: {
        ...
        personalTitle: "Complete your profile",
    ...
    group: {
        name: "Study team",
        new: "New study team",
        empty: "Create a study team to see them here.",
        emptyIncomplete: "Once you complete your profile, you can participate in study teams.",
        ...
        field: {
            ...
            subjects: "Keywords or search terms about your study",
            country: "Country",
            spatial: "Region",
            language: "Language",
        },
        ...
        invitations: {
            note: "Note: please additionally notify the person so they know the reason for the invite.",
            placeholder: "Enter person's email here",
            invite: "Invite",
        },
        help: {
            title: "",
            description: "A brief description of your study.",
            subjects: "What would people search for to find your study? Add some terms here (separated by commas).",
            country: "A list of one or more countries associated with your study.",
            spatial: "Region",
    ...
    pathway: {
        ...
        help: {
            ...
            subjects: "A list of keywords or search terms.",
            country: "A list of one or more countries associated with this study pathway.",
            spatial: "Region.",
        ...
        journey: {
            ...
            review: "Edit",
            startPersonal: "Begin your profile.",
            startResearch: "Create a new study for you or a team.",
    ...
    theme: {
        ...
        help: {
            title: "",
            description: "A complete description of the section.",
            subjects: "A list of keywords or search terms.",
            country: "Languages.",
            spatial: "Region.",
        },
    ...
    form: {
        ...
        branchNone: "Add a section to branch",
        booleanTrue: "True",
        booleanFalse: "False",
    ...
    comment: {
        ...
        close: "Close",
        empty: "Once your study teams start adding comments, you should see them here.",
    },
    collection: {
        metadata: "Metadata",
        translate: "Translating",
    ...
    search: {
        name: "View all studies",
        empty: "Search for studies",
    },
    frontpage: {
        title: "The 1000 Challenge Study Builder",
        description: "A collaborative system to introduce research into low-resource care settings by taking workers through the process and guiding every step and element that is needed to deliver good quality evidence that can change practice.",
        tghnFull: "The Global Health Network",
        tghn: "TGHN",
        getstarted: "Get started",
        learnmore: "Help",
        pathwayTitle: "Preview the steps",
    ...
    loginpage: {
        ...
        login: {
            ...
            descriptionEmail: "We'll send you an email with a magic link to login or create an account.",
            descriptionPassword: "You'll need to have set a password after first creating an account.",
            emailLabel: "Email address",
            passwordLabel: "Password",
            passwordForgot: "Forgot your password?",
            passwordPrefer: "Use password",
        },
        magic: {
            ...
            description2: "Make sure you use the same browser you requested the login from for it to work.",
    ...
    pwa: {
        dismiss: "Dismiss",
        install: "Install",
        install_title: "Install desktop app",
        title: "New desktop app update available!",
        update: "Update",
        update_available_short: "Update desktop app",
    },
}