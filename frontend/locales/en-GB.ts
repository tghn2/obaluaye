export default {
    ...
    settings: {
        ...
        account: {
            title: "Profile",
            description: "You will need to set a password before you can save your profile changes. Note, changing your email address will change your login. ",
            passwordRequired: "You will need to set a password before you can save your profile changes.",
    ...
    group: {
        ...
        help: {
            title: "",
            description: "A description of the study team.",
            subjects: "A list of keywords or search terms to describe the study.",
            country: "A list of one or more countries associated with this study team.",
            spatial: "Region",
