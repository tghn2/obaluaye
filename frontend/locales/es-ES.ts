export default {
    ...
    settings: {
        ...
        invitations: {
            ...
            completePathway: "You cannot participate in a study team until you have completed a personal pathway.",
            invited: "Invited",
            for: "For",
            by: "By",
            accept: "Accept",
    ...
    group: {
        ...
        emptyIncomplete: "Once you complete a personal pathway, you can participate in study teams.",
        ...
        help: {
            ...
            subjects: "A list of topics for the study team. Comma-separated.",
    ...
    pathway: {
        ...
        help: {
            ...
            subjects: "A list of topics of the study pathway. Comma-separated. Contains all languages.",
        ...
        journey: {
            ...
            review: "Review",
            startPersonal: "Begin your personal pathway.",
            startResearch: "Create a new study team and begin your collaborative study pathway.",
    ...
    theme: {
        ...
        help: {
            ...
            subjects: "A list of topics of the study step. Comma-separated. Contains all languages.",
            country: "A list of one or more languages appropriate to this study step.",
            spatial: "Spatial characteristics of the study step.",
        },
    },
    node: {
        name: "Process",
        ...
        help: {
            question: "",
            subjects: "A list of topics of the process. Comma-separated. Contains all languages.",
        },
    },
    form: {
        name: "Response type",
    ...
    frontpage: {
        ...
        pathwayTitle: "Study pathway report",
