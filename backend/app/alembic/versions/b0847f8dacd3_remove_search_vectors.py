...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('user', sa.Column('description_vector', postgresql.TSVECTOR(), sa.Computed("to_tsvector('simple'::regconfig, 'description'::text)", persisted=True), autoincrement=False, nullable=False))
    op.create_index('ix_user_description_vector', 'user', ['description_vector'], unique=False, postgresql_using='gin')
    op.add_column('themetitle', sa.Column('title_vector', postgresql.TSVECTOR(), sa.Computed("to_tsvector('simple'::regconfig, 'title'::text)", persisted=True), autoincrement=False, nullable=False))
    op.create_index('ix_theme_title_vector', 'themetitle', ['title_vector'], unique=False, postgresql_using='gin')
    op.add_column('themedescription', sa.Column('description_vector', postgresql.TSVECTOR(), sa.Computed("to_tsvector('simple'::regconfig, 'description'::text)", persisted=True), autoincrement=False, nullable=False))
    op.create_index('ix_theme_description_vector', 'themedescription', ['description_vector'], unique=False, postgresql_using='gin')
    op.add_column('subject', sa.Column('term_vector', postgresql.TSVECTOR(), sa.Computed("to_tsvector('simple'::regconfig, 'term'::text)", persisted=True), autoincrement=False, nullable=False))
    op.create_index('ix_subject_term_vector', 'subject', ['term_vector'], unique=False, postgresql_using='gin')
    op.add_column('resourcetitle', sa.Column('title_vector', postgresql.TSVECTOR(), sa.Computed("to_tsvector('simple'::regconfig, 'title'::text)", persisted=True), autoincrement=False, nullable=False))
    op.create_index('ix_resource_title_vector', 'resourcetitle', ['title_vector'], unique=False, postgresql_using='gin')
    op.add_column('resourcedescription', sa.Column('description_vector', postgresql.TSVECTOR(), sa.Computed("to_tsvector('simple'::regconfig, 'description'::text)", persisted=True), autoincrement=False, nullable=False))
    op.create_index('ix_resource_description_vector', 'resourcedescription', ['description_vector'], unique=False, postgresql_using='gin')
    op.add_column('pathwaytitle', sa.Column('title_vector', postgresql.TSVECTOR(), sa.Computed("to_tsvector('simple'::regconfig, 'title'::text)", persisted=True), autoincrement=False, nullable=False))
    op.create_index('ix_pathway_title_vector', 'pathwaytitle', ['title_vector'], unique=False, postgresql_using='gin')
    op.add_column('pathwaydescription', sa.Column('description_vector', postgresql.TSVECTOR(), sa.Computed("to_tsvector('simple'::regconfig, 'description'::text)", persisted=True), autoincrement=False, nullable=False))
    op.create_index('ix_pathway_description_vector', 'pathwaydescription', ['description_vector'], unique=False, postgresql_using='gin')
    op.add_column('group', sa.Column('title_vector', postgresql.TSVECTOR(), sa.Computed("to_tsvector('simple'::regconfig, 'title'::text)", persisted=True), autoincrement=False, nullable=False))
    op.add_column('group', sa.Column('description_vector', postgresql.TSVECTOR(), sa.Computed("to_tsvector('simple'::regconfig, 'description'::text)", persisted=True), autoincrement=False, nullable=False))
