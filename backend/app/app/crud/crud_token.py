...
from app.schemas import RefreshTokenCreate, RefreshTokenUpdate, RefreshToken as RefreshTokenOut
from app.core.config import settings


class CRUDToken(CRUDBase[Token, RefreshTokenCreate, RefreshTokenUpdate, RefreshTokenOut]):
