...
class PathwayBase(BaseSchema):
    ...
    isProtected: Optional[bool] = Field(
        False, description="Whether the pathway is protected to require views from logged-in users."
    )
    ...
    temporalStart: Optional[datetime] = Field(None, description="Temporal start of the pathway.")
    temporalEnd: Optional[datetime] = Field(None, description="Temporal end of the pathway.")
    ...
    bibliographicCitation: Optional[str] = Field(None, description="A bibliographic pathway for the pathway.")
